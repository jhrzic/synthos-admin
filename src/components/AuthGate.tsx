...
// ---------------------------------------------------------------------------
// SYNTHOS — minimal, real authentication gate (Pass III / A6).
//
...
// membership) is what this pass is about. This is only the thin client
// surface needed so the app remains usable once every real API route
// requires a real session: check setup/login state, render the matching
// form, then render the real app once authenticated.
// ---------------------------------------------------------------------------
...
type GateState = 'loading' | 'setup' | 'login' | 'authenticated' | 'error';
